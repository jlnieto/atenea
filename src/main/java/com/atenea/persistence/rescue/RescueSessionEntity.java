...
@Entity
@Table(name = "rescue_session")
public class RescueSessionEntity {
    ...
    private RescueSessionStatus status;
    ...
    public RescueSessionStatus getStatus() {
        return status;
    }

    public void setStatus(RescueSessionStatus status) {
        this.status = status;
    }
