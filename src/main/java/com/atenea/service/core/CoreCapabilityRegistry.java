...
public class CoreCapabilityRegistry {
    ...
    private final Map<String, CapabilityDefinition> definitions = Map.ofEntries(
            ...
            Map.entry(key(CoreDomain.DEVELOPMENT, "run_project_verification"),
                    definition(
                            CoreDomain.DEVELOPMENT,
                            ...
                            true,
                            true,
                            "Run the registered runtime verification for a project or active work session.",
                            "Use when the operator asks to test, verify, validate, run smoke tests, or check browser validation before deploy.",
                            "Do not use for passive progress summaries or for asking what Codex answered.",
                            List.of(
                                    requiredLong("projectId", "Project whose runtime contract should be verified."),
                                    optionalLong("workSessionId", "Active WorkSession associated with the verification when known.")),
                            List.of(
                                    new CapabilityExample("verifica fomasys antes de desplegar",
                                            "This requests project runtime and browser verification."),
                                    new CapabilityExample("pasa las pruebas de navegador de la sesión",
                                            "This runs the configured browser smoke checks for the active session.")))),
            Map.entry(key(CoreDomain.DEVELOPMENT, "refresh_project_database"),
                    definition(
                            CoreDomain.DEVELOPMENT,
                            ...
                            true,
                            true,
                            "Replace one project's local development database from its configured production/source database.",
                            "Use only when the operator explicitly asks to update, refresh, or replace the local database or BD for the active project.",
                            "Do not use for normal project verification, browser tests, test setup, migrations, or generic requests to leave an app working.",
                            List.of(
                                    requiredLong("projectId", "Project whose local database should be replaced."),
                                    optionalText("projectName", "Human project name used for voice confirmation.")),
                            List.of(
                                    new CapabilityExample("actualiza bd",
                                            "The operator explicitly requests a local database replacement for the active project."),
                                    new CapabilityExample("actualiza base de datos",
                                            "The operator explicitly requests a local database refresh."),
                                    new CapabilityExample("reemplaza bd",
                                            "The operator explicitly requests destructive local DB replacement."),
                                    new CapabilityExample("reemplaza base de datos",
                                            "The operator explicitly requests destructive local database replacement.")))),
