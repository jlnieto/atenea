...
CMD ["sh", "-lc", "umask 0002 && exec sh /usr/local/bin/codex-auth-guard codex app-server --listen ws://0.0.0.0:8092 -c 'approval_policy=\"never\"' -c 'sandbox_mode=\"danger-full-access\"' -c 'shell_environment_policy.inherit=\"all\"' -c 'projects.\"/workspace/repos\".trust_level=\"trusted\"' -c 'projects.\"/srv/atenea/workspace/repos\".trust_level=\"trusted\"'"]
