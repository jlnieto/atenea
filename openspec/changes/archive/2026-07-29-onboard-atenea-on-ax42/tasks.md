...
- [x] 6.5 Prove accepted Atenea remains available while non-onboarded projects remain disabled
...
- [x] 7.5 Run worker, manifest, Atenea focused and complete regression suites twice
...
- [x] 8.3 Run strict OpenSpec validation, confirm `45/45`, archive the completed change, commit and push both repositories
- [x] 8.4 Update the programme resume point to `onboard-beautips-on-ax42` and stop before enabling Beautips
